...
<div class="collectivity">
    ...
    <div class="container__base">
        <section class="services">
            ...
            <div class="services__card" data-aos-duration="800" data-aos="fade-down" data-aos-delay="500">
                @foreach(\App\Models\Services::where('service_types_id', '3')->get() as $service)
    ...
    <section class="avantages__collectivity">
...
<div class="container__base">
    <section class="contact__professionals" id="contact__collectivity" data-aos-duration="800" data-aos="fade-down" data-aos-delay="300">
        <form method="POST" action="{{ route('collectivity.send') }}" enctype="multipart/form-data">
            ...
            <div class="select-box" data-aos="fade-down" data-aos-duration="800" data-aos-delay="800">
                <select id="service" name="service[]" multiple required style="width: 100%;">
